...
func (x *GreetStreamRequest) Reset() {
	*x = GreetStreamRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_v1_hello_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetStreamRequest) Descriptor() ([]byte, []int) {
	return file_greet_v1_hello_proto_rawDescGZIP(), []int{2}
}
...
func (x *GreetStreamResponse) Reset() {
	*x = GreetStreamResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_greet_v1_hello_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GreetStreamResponse) Descriptor() ([]byte, []int) {
	return file_greet_v1_hello_proto_rawDescGZIP(), []int{3}
}

func (x *GreetStreamResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GreetStreamResponse) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
var file_greet_v1_hello_proto_rawDesc = []byte{
	0x0a, 0x14, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x39, 0x0a, 0x13, 0x47,
	...
	0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x32, 0x9a, 0x01, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74,
	...
	0x6d, 0x2f, 0x73, 0x75, 0x62, 0x6d, 0x61, 0x6c, 0x69, 0x6e, 0x65, 0x2f, 0x74, 0x75, 0x69, 0x2d,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74,
...
var (
	...
	file_greet_v1_hello_proto_rawDescData = file_greet_v1_hello_proto_rawDesc
)

func file_greet_v1_hello_proto_rawDescGZIP() []byte {
	file_greet_v1_hello_proto_rawDescOnce.Do(func() {
		file_greet_v1_hello_proto_rawDescData = protoimpl.X.CompressGZIP(file_greet_v1_hello_proto_rawDescData)
	})
	return file_greet_v1_hello_proto_rawDescData
}

var file_greet_v1_hello_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_greet_v1_hello_proto_goTypes = []interface{}{
...
func file_greet_v1_hello_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_greet_v1_hello_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_greet_v1_hello_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_greet_v1_hello_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_greet_v1_hello_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_greet_v1_hello_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_greet_v1_hello_proto_rawDesc = nil
